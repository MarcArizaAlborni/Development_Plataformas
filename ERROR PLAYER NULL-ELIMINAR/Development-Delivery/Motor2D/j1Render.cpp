...
bool j1Render::Update(float dt)
{
	...
	//int CameraPlayerPosX = App->entityManager->player->position.x;
	//int CameraPlayerPosY = App->entityManager->player->position->y;
	camera.x = -App->entityManager->player->CurrentPosition.x + winH;
	//camera.x = CameraPlayerPosX;
	if (camera.x >= 0)
	{
		camera.x = 0;
	}
